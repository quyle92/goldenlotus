...
if($denngay == "")
{
  ...
  //---thang
  //
  $sql="SELECT SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) like '".substr($tungay,6)."/01' Then TongTien Else 0 END) as DoanhThuT1, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/02' Then TongTien Else 0 END) as DoanhThuT2, 
  SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/03' Then TongTien Else 0 END) as DoanhThuT3, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/04' Then TongTien Else 0 END) as DoanhThuT4, 
  SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".  substr($tungay,6)."/05' Then TongTien Else 0 END) as DoanhThuT5, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/06' Then TongTien Else 0 END) as DoanhThuT6, 
  SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/07' Then TongTien Else 0 END) as DoanhThuT7, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/08' Then TongTien Else 0 END) as DoanhThuT8, 
  SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/09' Then TongTien Else 0 END) as DoanhThuT9, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/10' Then TongTien Else 0 END) as DoanhThuT10, 
  SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0118) = '".substr($tungay,6)."/11' Then TongTien Else 0 END) as DoanhThuT11, 
SUM(CASE WHEN substring(Convert(varchar,GioVao,111),0,11) = '".substr($tungay,6)."/12' Then TongTien Else 0 END) as DoanhThuT12 
