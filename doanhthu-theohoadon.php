...
const CHART2 = document.getElementById('bill-revenue');
var speedData = {
  labels: ["bill001", "bill002", "bill003", "bill004", "bill005", "bill006","bill007","bill008","bill009","bill010"],
  datasets: [{
    label: "Car Speed",
    data: [20, 59, 75, 20, 20, 55,97, 20, 55,97],
    fill: false,
