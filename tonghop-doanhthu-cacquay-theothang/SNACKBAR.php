<div class="col-md-4">
  <form action="" id="customMonth_<?=$r['TenQuay']?>" method="post" class="form-horizontal">
     ...
     <div class="form-group"> 
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 input-group date">
          <input name="tuThang" type='text' class="form-control" id="tuThang" value="<?= date('M y') ?>"/>
...
$('body').on('submit', 'form#customMonth_<?=$r['TenQuay']?>', function (event){
...
$(function () {
  ...
  var dateNow = new Date();
   $('form#customMonth_<?=$r['TenQuay']?> #tuThang').datetimepicker({
     // viewMode: 'years',
      useCurrent: false,
      format: 'MMM YYYY',
      //defaultDate:dateNow
